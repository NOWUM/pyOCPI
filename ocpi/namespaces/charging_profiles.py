...
from ocpi.models.charging_profiles import (
    ...
    ClearProfileResult,
    SetChargingProfile,
    add_models_to_charging_profiles_namespace,
)
from ocpi.namespaces import get_header_parser, make_response, token_required
...
def receiver():
    ...
    class manage_charging_profiles(Resource):
        ...
        @charging_profiles_ns.marshal_with(
            resp(charging_profiles_ns, ChargingProfileResponse)
        )
        @token_required
        def get(self, session_id):
            ...
            return make_response(
                self.chargingprofilesmanager.getChargingProfile,
                session_id,
                args["duration"],
                args["response_url"],
            )
        ...
        def put(self, session_id):
            ...
            """
            return make_response(
                self.chargingprofilesmanager.putChargingProfile,
                session_id,
                charging_profiles_ns.payload,
            )
        ...
        def delete(self, session_id):
            ...
            args = parser.parse_args()
            return make_response(
                self.chargingprofilesmanager.deleteChargingProfile,
                session_id,
                args["response_url"],
            )
...
def sender():
    ...
    class active_charging_profile_result(Resource):
        ...
        def post(self, session_id):
            return make_response(
                self.chargingprofilesmanager.handleActiveChargingProfileResult,
                session_id,
                charging_profiles_ns.payload,
            )
    ...
    class charging_profile_result(Resource):
        ...
        def post(self, session_id):
            return make_response(
                self.chargingprofilesmanager.handleChargingProfileResult,
                session_id,
                charging_profiles_ns.payload,
            )
    ...
    class clear_profile_result(Resource):
        ...
        def post(self, session_id):
            return make_response(
                self.chargingprofilesmanager.handleClearProfileResult,
                session_id,
                charging_profiles_ns.payload,
            )
    ...
    class update_sender_active_charging_profile(Resource):
        ...
        def put(self, session_id):
            ...
            return make_response(
                self.chargingprofilesmanager.handleUpdateActiveChargingProfile,
                session_id,
                charging_profiles_ns.payload,
            )
