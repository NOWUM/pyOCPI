...
from ocpi.models.tokens import LocationReferences, Token, add_models_to_tokens_namespace
...
def sender():
    ...
    class validate_token(Resource):
        ...
        def post(self, token_uid):
            ...
            return make_response(
                self.tokensmanager.validateToken,
                token_uid,
                args.get("type"),
                tokens_ns.payload,
            )
