...
from ocpi.models.reservation import Reservation, add_models_to_reservation_namespace
...
def receiver():
    @reservation_ns.route(
        ...
        doc={"description": "API Endpoint for Reservation management"},
    )
    ...
    class update_reservations(Resource):
        ...
        def get(self, country_id, party_id, reservation_id):
            ...
            return make_response(
                self.reservation_manager.getReservation,
                country_id,
                party_id,
                reservation_id,
            )
        ...
        def put(self, country_id, party_id, reservation_id):
            ...
            return make_response(
                self.reservation_manager.addReservation,
                country_id,
                party_id,
                reservation_ns.payload,
            )
        ...
        def patch(self, country_id, party_id, reservation_id):
            ...
            return make_response(
                self.reservation_manager.updateReservation,
                country_id,
                party_id,
                reservation_ns.payload,
            )
    ...
    class get_reservation(Resource):
        ...
        @reservation_ns.doc(
            params={
                "from": {
                    "in": "query",
                    "description": "declare Reservation start point",
                    "default": "2021-01-01T13:30:00+02:00",
                    "required": True,
                },
                "to": {
                    "in": "query",
                    "description": "declare Reservation end point",
        ...
        def get(self):
            ...
            return make_response(
                self.reservation_manager.getReservations,
                args["from"],
                args["to"],
                args["offset"],
                args["limit"],
