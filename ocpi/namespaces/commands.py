...
def receiver():
    ...
    class start_session_result(Resource):
        ...
        def post(self):
            ...
            token = _check_access_token()
            data = self.cm.startSessionResult(commands_ns.payload, token)
            return {'data': data,
                    'status_code': 1000,
                    'status_message': 'nothing',
                    'timestamp': datetime.now()
    ...
    class stop_session_result(Resource):
        ...
        def post(self):
            ...
            token = _check_access_token()
            data = self.cm.stopSessionResult(commands_ns.payload, token)
            return {'data': data,
                    'status_code': 1000,
                    'status_message': 'nothing',
                    'timestamp': datetime.now()
    ...
    class unlock_connector_result(Resource):
        ...
        def post(self):
            ...
            data = self.command_manager.unlockConnectorResult(commands_ns.payload)
            return {'data': data,
                    'status_code': 1000,
                    'status_message': 'nothing',
                    'timestamp': datetime.now()
    ...
    class cancel_reservation_result(Resource):
        ...
        def post(self):
            ...
            token = _check_access_token()
            data = self.cm.cancelReservationResult(commands_ns.payload, token)
            return {'data': data,
                    'status_code': 1000,
                    'status_message': 'nothing',
                    'timestamp': datetime.now()
    ...
    class reserve_now_result(Resource):
        ...
        def post(self):
            '''Reserve Now Answer'''
            token = _check_access_token()
            data = self.cm.reserveNowResult(commands_ns.payload, token)
            return {'data': data,
                    'status_code': 1000,
                    'status_message': 'nothing',
                    'timestamp': datetime.now()
