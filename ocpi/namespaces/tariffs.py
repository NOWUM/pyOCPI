...
from ocpi.models.tariffs import Tariff, add_models_to_tariffs_namespace
    ...
    class manage_tariffs(Resource):
        ...
        def get(self, country_code, party_id, tariff_id):
            ...
            return make_response(
                self.tariffsmanager.getTariff, country_code, party_id, tariff_id
            )
...
def sender():
    ...
    class get_tariffs(Resource):
        ...
        def get(self):
            ...
            return make_response(
                self.tariffsmanager.getTariffs,
                args["from"],
                args["to"],
                args["offset"],
                args["limit"],
