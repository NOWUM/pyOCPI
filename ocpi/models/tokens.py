...
Token = Model('Token', {
    ...
    'whitelist': fields.Nested(whitelist_type, required=True, description='Indicates what type of white-listing is allowed.'),
...
AuthorizationInfo = Model('AuthorizationInfo', {
    'allowed': fields.Nested(allowed_type, required=True, description='Status of the Token, and whether charging is allowed at the optionally given location.'),
