...
CdrDimension = Model(
    ...
    {
        "type": fields.String(
            enum=cdr_dimension_type, required=True, description="Type of CDR dimension."
        ),
        "volume": fields.Float(
            required=True,
...
CdrLocation = Model(
    "CdrLocation",
    {
        ...
        "name": fields.String(
            max_length=255, required=False, description="Display name of the location."
        ),
        ...
        "postal_code": fields.String(
            max_length=10, required=True, description="Postal code of the location."
        ),
        ...
        "connector_standard": fields.String(
            enum=connector_type,
            required=True,
            description="The standard of the installed connector.",
        ),
        "connector_format": fields.String(
            enum=connector_format,
            required=True,
            description="The format (socket/cable) of the installed connector.",
        ),
        "connector_power_type": fields.String(
            enum=power_type, required=True, description=""
        ),
    },
)
...
SignedData = Model(
    "SignedData",
    {
        "encoding_method": CaseInsensitiveString(
            max_length=36,
            required=True,
        ...
        "encoding_method_version": fields.Integer(
            required=False,
        ...
        "signed_values": fields.List(
            fields.Nested(SignedValue),
            required=True,
...
Cdr = Model(
    "Cdr",
    {
        ...
        "session_id": CaseInsensitiveString(
            max_length=36,
            required=False,
        ...
        "total_fixed_cost": fields.Nested(
            Price,
            required=False,
        ...
        "total_energy": fields.Float(
            required=True, description="Total energy charged, in kWh."
        ),
        "total_energy_cost": fields.Nested(
            Price,
            required=False,
        ...
        "total_parking_cost": fields.Nested(
            Price,
            required=False,
        ...
        "total_reservation_cost": fields.Nested(
            Price,
            required=False,
        ...
        "invoice_reference_id": CaseInsensitiveString(
            max_length=39,
            required=False,
        ...
        "credit_reference_id": CaseInsensitiveString(
            max_length=39,
            required=False,
