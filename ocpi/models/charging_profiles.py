...
ChargingProfile = Model('ChargingProfile', {
    ...
    'charging_rate_unit': fields.Nested(charging_rate_unit, required=True, description='The unit of measure.'),
...
ChargingProfileResult = Model('ChargingProfileResult', {
    'result': fields.Nested(charging_profile_result_type, required=True, description='The EVSE will indicate if it was able to process the new/updated charging profile.')
})

ClearProfileResult = Model('ClearProfileResult', {
    'result': fields.Nested(charging_profile_result_type, required=True, description='The EVSE will indicate if it was able to process the removal of the charging profile (ClearChargingProfile).')
})
